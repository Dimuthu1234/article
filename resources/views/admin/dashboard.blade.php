...
<section>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h4 class="p-title"><b>ADMIN DASHBOARD</b></h4>
                <div class="row">
                    <div class="col-md-3 admin-sidebar">
                    <ul>
                        <li><a href="#"><i class="fa fa-user"></i>&nbsp;USER</a></li>
                        <li><a href="#"><i class="fa fa-contao"></i>&nbsp;SEO</a></li>
                        <li><a href="#"><i class="fa fa-bars"></i>&nbsp;ARTICLE</a></li>

                    </ul>
                    </div>
                    <div class="col-md-9">
                        <div class="col-md-2 dash-box">
                            <i class="fa fa-3x fa-user"></i><br><hr>
                            <span>27</span>
                        </div>
                        <div class="col-md-2 col-md-offset-1 dash-box">
                            <i class="fa fa-3x fa-search"></i><br><hr>
                            <span>27</span>
                        </div>
                        <div class="col-md-2 col-md-offset-1 dash-box">
                            <i class="fa fa-3x fa-home"></i><br><hr>
                            <span>27</span>
                        </div>
                        <div class="col-md-2 col-md-offset-1 dash-box">
                            <i class="fa fa-3x fa-bars"></i><br><hr>
                            <span>27</span>
                        </div>
                    </div>
