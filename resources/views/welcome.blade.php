        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-8">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <img src="{{ url('images/recent-news-1-600x450.jpg') }}" alt="">
                    ...
                    <div class="col-sm-6">
                        <a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
                            <div class="wh-100x abs-tlr"><img src="{{ url('images/polular-1-100x100.jpg') }}" alt=""></div>
                        ...
                        <a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
                            <div class="wh-100x abs-tlr"><img src="{{ url('images/polular-2-100x100.jpg') }}" alt=""></div>
                            <div class="ml-120 min-h-100x">
                                <h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
                                <h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
                            </div>
                        ...
                        <a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
                            <div class="wh-100x abs-tlr"><img src="{{ url('images/polular-3-100x100.jpg') }}" alt=""></div>
                            <div class="ml-120 min-h-100x">
                                <h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
                                <h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
                            </div>
                        ...
                        <a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
                            <div class="wh-100x abs-tlr"><img src="{{ url('images/polular-4-100x100.jpg') }}" alt=""></div>
                            <div class="ml-120 min-h-100x">
                                <h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
                                <h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
                            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="pl-20 pl-md-0">
                    ...
                    <div class="mtb-50 pos-relative">
                        <img src="{{ url('images/banner-1-600x450.jpg') }}" alt="">
    ...
    <div class="container">
        <div class="pt-50 pb-20 pos-relative">
            <div class="abs-tblr pt-50 z--1 text-center">
                <div class="h-80 pos-relative"><img class="opacty-1 h-100 w-auto" src="{{ url('images/map.png') }}" alt=""></div>
            </div>
            <div class="row">

                <div class="col-sm-4">
                    <div class="mb-30">
                        <a href="#"><img src="{{ url('images/logo-white.png') }}"></a>
